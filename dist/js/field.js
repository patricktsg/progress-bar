...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-progress-bar', __webpack_require__(3));
    Vue.component('detail-progress-bar', __webpack_require__(6));
    Vue.component('form-progress-bar', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        setBarColor: function setBarColor(value) {
            if (value < 50) {
                return '#ef5753';
            } else if (value <= 60) {
                return '#de751f';
...
var render = function() {
  ...
  return _c("div", { staticClass: "flex" }, [
    _c(
      ...
      [
        _c("div", {
          staticClass: "rounded-lg p-1 progbar",
          staticStyle: { height: "16px", clear: "both" },
          style: {
            background: _vm.setBarColor(_vm.field.value),
            width: _vm.field.value + "%"
          }
        })
      ]
    )
